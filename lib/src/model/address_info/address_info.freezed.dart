...
class _$_AddressInfo implements _AddressInfo {
  _$_AddressInfo(
      {@JsonKey(name: 'title') required this.id,
      @JsonKey(name: 'addressInfoLine') required this.title,
  ...
  @override
  String toString() {
    return 'AddressInfo(id: $id, title: $title, province: $province, country: $country, latitude: $latitude, longitude: $longitude, contactPhone: $contactPhone, contactEmail: $contactEmail)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, province, country,
