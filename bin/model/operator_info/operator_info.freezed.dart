...
class _$OperatorInfoCopyWithImpl<$Res, $Val extends OperatorInfo>
  ...
  $Res call({
    ...
    Object? isPrivateIndividual = null,
    ...
    return _then(_value.copyWith(
      ...
      contactPhone: freezed == contactPhone
          ...
          : contactPhone // ignore: cast_nullable_to_non_nullable
              as String?,
      isPrivateIndividual: null == isPrivateIndividual
...
class _$_OperatorInfo implements _OperatorInfo {
  _$_OperatorInfo(
      ...
      @JsonKey(name: 'webSiteUrl') required this.webSiteUrl,
      @JsonKey(name: 'contactPhone') required this.contactPhone,
      @JsonKey(name: 'isPrivateIndividual') required this.isPrivateIndividual,
      @JsonKey(name: 'addressInfo') required this.addressInfo,
      @JsonKey(name: 'contactEmail') required this.contactEmail,
      @JsonKey(name: 'appStoreUrl') required this.appStoreUrl,
      @JsonKey(name: 'googlePlayUrl') required this.googlePlayUrl});
...
abstract class _OperatorInfo implements OperatorInfo {
  factory _OperatorInfo(
      ...
      @JsonKey(name: 'addressInfo')
          required final String addressInfo,
      @JsonKey(name: 'contactEmail')
          required final String? contactEmail,
      @JsonKey(name: 'appStoreUrl')
          required final String? appStoreUrl,
      @JsonKey(name: 'googlePlayUrl')
          required final String? googlePlayUrl}) = _$_OperatorInfo;
